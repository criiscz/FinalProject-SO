...
public class Filosofo extends Thread {
    ...
    public void run() {
        while (true) { // Se repite infinitamente While
            ...
            try { // try / catch
                ...
                if (!izqda.cogerTenedorIzqdo(id, log)) {
                    ...
                    if (Clase10Control.getjTextArea_Log() != null)
                        log.escribirLog(" El Filósofo " + (id + 1) + " tendrá que soltar el tenedor " + (id + 1) + " por exceso de tiempo y salir a pensar.");
                    ...
                    if (Clase10Control.getjTextArea_Log() != null)
                        log.escribirLog(" El Filósofo " + (id + 1) + " está pensando.");
                    try {
                ...
                if (Clase10Control.getjTextArea_Log() != null)
                    log.escribirLog(" El Filósofo " + (id + 1) + " está comiendo.");
        ...
        try {
            if (Clase10Control.getjTextArea_Log() != null)
                log.escribirLog(" La cena ha terminado para todos: El Filósofo " + (id + 1) + " se ha puesto a pensar.\n\n Pulsar Iniciar para continuar.\n\n");
        } catch (InterruptedException ex) {
